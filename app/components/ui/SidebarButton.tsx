...
export default function SidebarButton({icon, children, ...other}: SidebarButtonProps){
    ...
    return (
        <NavLink className={({ isActive  }) =>
                     isActive
                         ? "w-full px-6 py-3 bg-teal-850 flex gap-3 items-center rounded-xl border-2 border-teal-750"
                         : "w-full px-6 py-3 bg-teal-990 flex gap-3 items-center rounded-xl border-2 border-teal-750 transition duration-200 hover:bg-teal-950"
                 }
