...
const variants = {
    primary: 'px-8 py-3 bg-purple-400 justify-center items-center rounded-2xl inline-flex font-sans font-semibold text-white gap-2.5 leading-none hover:bg-purple-300 transition duration-200',
    secondary: 'px-8 py-3 bg-purple-900 justify-center items-center rounded-2xl inline-flex font-sans font-semibold text-purple-400 gap-2.5 leading-none hover:bg-purple-800 transition duration-200',
