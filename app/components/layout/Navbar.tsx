        ...
        <div className="px-8 flex gap-12 items-center">
          <div className="flex gap-4 items-center">
            <img
              ...
              src="/brand/parkinsonspulse_icon-LIGHT2.png"
              alt=""
            ></img>

            <a
              className="flex gap-4 justify-between items-end leading-3"
              href={
                variant === "patient"
          ...
          <div className="gap-4 items-center lg:flex hidden">
            {isSidebarOpen ? (
              <NavbarButton variant="sidebarActive" onClick={toggleSidebar}>
                Sidebar
              </NavbarButton>
            ) : (
              <NavbarButton variant="sidebar" onClick={toggleSidebar}>
                Sidebar
              </NavbarButton>
            )}
            <NavbarButton
